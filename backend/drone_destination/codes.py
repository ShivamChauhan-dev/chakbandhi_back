...
class ErrorCode(IntEnum):
    ...
    NOT_FOUND = 25, "Not Found", "Object not found"
    REQUEST_THROTTLED = 26, "Throttled", "Request was throttled."
    ...
    def get_http_status_code(self) -> HTTPStatus:
        ...
        elif self.is_REQUEST_THROTTLED():
    ...
    def is_REQUEST_THROTTLED(self):
        return self.is_same(ErrorCode.REQUEST_THROTTLED)
