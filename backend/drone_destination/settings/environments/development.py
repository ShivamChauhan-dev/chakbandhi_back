...
from drone_destination.settings.components import config

# from drone_destination.settings.components.csp import (
#     CSP_CONNECT_SRC,
#     CSP_IMG_SRC,
#     CSP_SCRIPT_SRC,
# )
...
OTP_PROVIDER_INFO = {
    'host': 'http://makemysms.in/api/sendsms.php',
    'para': {
        "username": "gtenG",
        "password": "b3163558",
        "template": 1707161926977279527,
        "sender": "GTENCD",
        "type": 1,
        "product": 1,
    }
